...
>
> I also found that Awesome Blueprints Matt has a blueprint to send persistent notifications to your phone, so I reference that here to be helpful if you are looking for that. If you want to send these notifications to a mobile device, i suggest you look at [this blueprint](https://github.com/EPMatt/awesome-ha-blueprints/tree/main/blueprints/automation/persistent_notification_to_mobile) to use in conjunction with my blueprint. I am not affiliated with that, but decided I didn't want to re-invent the wheel as mobile HA is not something I do every day.
...
Requirements
    ...
    Persistent Notification Integration Required
        ...
        integration. This should be activated in yur HA Instance by default, 
